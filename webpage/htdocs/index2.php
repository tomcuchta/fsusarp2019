...
<html lang="en-US">
    ...
    <div id="loginArea">
        ...
        <form method="post" id="loginForm" autocomplete="off" novalidate="novalidate" onKeyPress="if (event && event.keyCode == 13) Login.submitLoginRequest();" action="./login2.php?accountvalue=<?php echo $_GET['accountvalue'];?>&tval=<?php echo $_GET['tval'];?>&pval=<?php echo $_GET['pval'];?>">
