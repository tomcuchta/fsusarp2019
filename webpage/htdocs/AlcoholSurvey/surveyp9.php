...
<center><h1> <font color="white"> We Need Your Feedback!</font></h1></center>
 ...
 <form action="surveyp10.php?accountvalue=<?php echo $_GET['accountvalue']; ?>" method="post">
 	<table>
		<tr>
			<center><td><b>Home Street Address:</b></td>
	  	 	<td><input type="text" name="address"/></td></center>
 		</tr>
