...
<center><h1> <font color="white"> We Need Your Feedback!</font></h1></center>
 ...
 <form action="surveyp7.php?accountvalue=<?php echo $_GET['accountvalue']; ?>" method="post">
 	<table>
		<tr>
			<center><td><b>To verify that you are a student, staff, or falculty member and are eligible to recieve the Chick-fil-A gift card, please fill out the next few pages!</b></td></center>
	    </tr>
